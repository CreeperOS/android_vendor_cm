...
ALARM_PATH := vendor/creeper/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/creeper/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/creeper/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/creeper/prebuilt/common/media/audio/ui
